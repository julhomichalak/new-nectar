...
<body>
  ...
  <main class="main" id="top">
    ...
    <div class="content">
      ...
      <div class="row d-flex align-items-center">
        <div class="mb-3 col-lg-9 col-md-12" id="cardTasks" style="min-height:100%!important">

          <div class=" card todo-list" id="cardTodoList" style="min-height:100%!important">
            <div class="card-header border-bottom-0 pb-0">
              <div class="row justify-content-between align-items-center mb-4">
                <div class="col-auto">
                  <h3 class="text-body-emphasis">Execução</h3>
                </div>
        ...
        <div class="col-lg-3 col-md-12" id="cardsLaterais">
          <!-- INICIO::HABITOS -->
          <div class="card mb-3">
            <div class="card-header mt-3 py-0">
              <div class="card-title">Hábitos</div>
            </div>
            <div class="card-body d-grid gap-3">
              <div class="form-check">
                <input class="form-check-input habit-checkbox" type="checkbox" value="" id="habit-77" checked />
                <label class="form-check-label" for="habit-77" style="text-decoration: line-through;">Academia</label>
              </div>
              <div class="form-check">
                <input class="form-check-input habit-checkbox" type="checkbox" value="" id="habit-78" />
                <label class="form-check-label" for="habit-78">Leitura</label>
              </div>
              <div class="form-check">
                <input class="form-check-input habit-checkbox" type="checkbox" value="" id="habit-97" />
                <label class="form-check-label" for="habit-97">Beber 2L de água</label>
              </div>
              <div class="form-check">
                <input class="form-check-input habit-checkbox" type="checkbox" value="" id="habit-97" />
                <label class="form-check-label" for="habit-97">Meditação</label>
              </div>
            </div>
          </div>
          <!-- FIM::HABITOS -->
          ...
          <div class="card mb-3">
            ...
            <div class="card-body d-grid gap-3">
              ...
              <div class="form-check">
                <input class="form-check-input habit-checkbox" type="checkbox" value="" id="habit-97" />
                <label class="form-check-label" for="habit-97">Aniversário Iago - <i>Hoje</i></label>
              </div>
              <div class="form-check">
                <input class="form-check-input habit-checkbox" type="checkbox" value="" id="habit-97" />
                <label class="form-check-label" for="habit-97">Reunião Semanal - <i>15/11/2024</i></label>
              </div>
              <div class="form-check">
                <input class="form-check-input habit-checkbox" type="checkbox" value="" id="habit-97" />
                <label class="form-check-label" for="habit-97">Aniversário Julho - <i>21/11/2024</i></label>
              </div>
            </div>
            <!-- <div class="card-body d-grid gap-3">
              <p class="text-center">Nenhum compromisso incluído</p>
            </div> -->
          </div>
          <!-- FIM::COMPROMISSOS -->

          <!-- INICIO::CITAÇÃO -->
          <div class="card mb-3" id="cardCitacao">
            <div class="card-body">
              <figure>
                <blockquote class="blockquote">
                  <p>Agarra-se à tarefa de hoje e não precisará depender do amanhã.</p>
                </blockquote>
                <figcaption class="blockquote-footer">
                  Sêneca nas <cite title="Source Title">Cartas a Lucílio</cite>
                </figcaption>
              </figure>
            </div>
          </div>
        ...
        <div class="col-12 mb-9">
          ...
          <!-- Coluna do calendario -->
          <div class="col-md-12 row justify-content-center align-items-center " data-todo-offcanvas-toogle="data-todo-offcanvas-toogle" data-todo-offcanvas-target="todoOffcanvas-1">
            ...
            <div class="mx-n4 px-4 mx-lg-n6 px-lg-6 border-y border-translucent">
              <div class="row py-3 gy-3 gx-0">
                ...
                <div class="col-12 col-md-4 order-md-1 d-flex align-items-center justify-content-center">
                  <button class="btn icon-item icon-item-sm shadow-none text-body-emphasis p-0" type="button"
                    data-event="prev" title="Previous"><span class="fas fa-chevron-left"></span></button>
                  <h3 class="px-3 text-body-emphasis fw-semibold calendar-title mb-0"> </h3>
                  <button class="btn icon-item icon-item-sm shadow-none text-body-emphasis p-0" type="button"
                    data-event="next" title="Next"><span class="fas fa-chevron-right"></span></button>
                </div>
                <div class="col-6 col-md-4 ms-auto order-1 d-flex justify-content-end">
                  <div>
                    <div class="btn-group btn-group-sm" role="group">
                      ...
                      <button class="btn btn-phoenix-secondary" data-fc-view="listWeek">Semana</button>
  ...
  <script>
    ...
    function ajustarAltura() {
      const cardsLaterais = document.getElementById('cardsLaterais');
      const cardTasks = document.getElementById('cardTasks');

      // Verifica se o elemento existe
      if (cardsLaterais && cardTasks) {
        // Pega a altura do elemento #cardsLaterais
        const altura = cardsLaterais.offsetHeight - 16;

        // Aplica a altura ao elemento #cardTasks
        cardTasks.style.height = altura + 'px';
      }
    }

    // Verifica se o tamanho da tela é de desktop
    function verificarTamanhoTela() {
      if (window.innerWidth >= 991) { // Exemplo: 768px para telas de desktop
        ajustarAltura();
      } else {
        // Opcional: Reinicia a altura se não for desktop
        const cardTasks = document.getElementById('cardTasks');
        if (cardTasks) {
          cardTasks.style.height = 'auto'; // Reseta para auto em dispositivos móveis
        }
      }
    }
